...
<div className="flex flex-col md:flex-row items-center justify-between gap-2">
  ...
  <div className="flex flex-col items-center animate-arrow">
    <span className="hidden md:flex items-center justify-center text-2xl bg-blue-100 rounded-full w-10 h-10 pb-2">
      👉
    </span>
    <span className="md:hidden flex items-center justify-center text-2xl bg-blue-100 rounded-full w-10 h-10 mt-2">
      👇
    </span>
  </div>
  ...
  {/* STEP 3 */}
  <div className="flex flex-col items-center w-full md:w-[22%] animate-fadeSlideDelay3">
...
{/* BOTTOM SECTION – Powerful AI Interview Experience */}
<div className="mt-20">
  ...
  <p className="text-center max-w-3xl mx-auto text-gray-700 text-lg leading-relaxed mb-14 animate-fadeIn">
    Our platform helps you practice 
    real interview scenarios, improve your confidence, and get job-ready with smart insights.  
    No fluff only practical, powerful mock interviews designed for your success.
  </p>
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
    ...
    {/* CARD 1 */}
    <div className="glass-card p-6 rounded-2xl shadow-xl hover:scale-[1.03] transition-all duration-300 animate-slideUp">
      ...
      <p className="text-gray-700 leading-relaxed">
        ...
        Completely tailored to your resume and role.
      </p>
    </div>

    {/* CARD 2 */}
    <div className="glass-card p-6 rounded-2xl shadow-xl hover:scale-[1.03] transition-all duration-300 delay-100 animate-slideUp">
      <h3 className="font-semibold text-xl theme-text mb-3">📊 Instant Smart Feedback</h3>
      <p className="text-gray-700 leading-relaxed">
        Receive insights on structure, tone, clarity, and confidence — powered by our 
        interview evaluation AI engine.
      </p>
    </div>

    {/* CARD 3 */}
    <div className="glass-card p-6 rounded-2xl shadow-xl hover:scale-[1.03] transition-all duration-300 delay-200 animate-slideUp">
      <h3 className="font-semibold text-xl theme-text mb-3">🎧 Voice-Based Interview Mode</h3>
      <p className="text-gray-700 leading-relaxed">
        Experience real-time audio interviews with AI using advanced speech models 
        for a real interviewer feel.
      </p>
    </div>
