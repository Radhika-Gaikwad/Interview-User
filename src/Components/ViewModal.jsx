      ...
      <div className="relative z-[1000000] w-[96%] lg:w-[1100px] max-h-[92vh] bg-white rounded-2xl shadow-2xl flex flex-col">
        ...
        <div className="p-6 overflow-y-auto space-y-8">
          ...
          {Array.isArray(data.skills) && data.skills.length > 0 && (
            <div className="glass rounded-xl p-5">
              <h4 className="text-lg font-semibold theme-text mb-4">Skills</h4>
              <div className="flex flex-wrap gap-2">
          ...
          {Array.isArray(data.education) && data.education.length > 0 && (
            <div>
              ...
              {data.education.map((edu, i) => (
                <div
                  key={i}
                  className="glass-card rounded-xl p-5 hover-faint-gradient transition mb-4"
                >
          ...
          <div className="p-4">
            <div className="glass-card rounded-xl overflow-hidden">
              <h4 className="text-lg font-semibold theme-text px-5 pt-5 mb-3">
                Resume Preview
              </h4>
              {previewSrc ? (
                <iframe
