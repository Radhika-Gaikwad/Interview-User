...
const SignIn = () => {
  ...
  return (
    <div className="relative min-h-screen md:h-screen theme-bg flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute w-[500px] h-[500px] bg-white/10 rounded-full blur-3xl animate-blob animation-delay-2000 -bottom-20 -right-10"></div>
        ...
        <div className="flex flex-col justify-start lg:px-24 py-5 px-5 glass">
          ...
          <div className="mb-5 text-center mt-3">
            ...
            <p className="text-indigo-700 font-semibold mt-1 text-sm tracking-wide">
              Level up your interview journey 🚀
            </p>
          </div>
          ...
          <form className="space-y-6 lg:px-6">
            ...
            <div className="flex items-center justify-between text-sm mt-1">
              ...
              <a className="text-indigo-600 font-semibold hover:underline cursor-pointer">
                Forgot password?
              </a>
            </div>
            ...
            <button
              ...
              className="
                ...
                py-3 text-lg rounded-xl
                shadow-xl hover:scale-[1.03] active:scale-95 transition font-semibold
              "
            >
              Login
            </button>
